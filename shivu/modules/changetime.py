...
async def change_time(client: Client, message: Message):
    ...
    if member.status not in ADMINS and user_id != OWNER_ID:
    ...
    try:
        ...
        if new_frequency < 100 and user_id != OWNER_ID:
        ...
        await message.reply_text(f'Successfully changed the message frequency to {new_frequency}.')
